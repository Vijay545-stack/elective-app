...
app.post('/api/forms', requireAuth, async (req, res) => {
  ...
  if (!electives.length) {
    ...
    return res.status(400).json({
      ...
      error:
        'Add at least one elective with a seat count above 0.'
  ...
  async (req, res) => {
    ...
    if (
      ...
      return res.status(400).json({
        ...
        error:
          'Please fill in all fields and choose an elective.'
